  ...
  return (
    <div className={cn(className)}>
      <Select value={theme} onValueChange={handleChangeTheme}>
        ...
        <SelectContent>
          <SelectItem value="light">{t('components.inputs.theme.items.light_mode')}</SelectItem>
          <SelectItem value="dark">{t('components.inputs.theme.items.dark_mode')}</SelectItem>
