...
import ListAttendanceCourseClassRecord from '@features/attendance/list-attendance-course-class-record'
import CreateRecordCourseClassModal from '@features/attendance/create-record-course-class-modal'
...
export const Route: FC = () => {
  ...
  return (
    <ContentPageLayout  titlePage={t('common.attendance_by_subjects')}>
      <div className="flex flex-col gap-10">
        <div className="flex flex-col justify-between gap-3 md:flex-row">
          ...
          />
          <CreateRecordCourseClassModal
            onCreate={({ courseClass, period }) =>
              navigate(
                cleanPath(
                  `/${prefixRoute}/attendance/subjects/new-record?class=${courseClass}&period=${period}`,
                ),
              )
            }
          >
        ...
        {<ListAttendanceCourseClassRecord filter={filter} />}
      </div>
    </ContentPageLayout>
  )
}
