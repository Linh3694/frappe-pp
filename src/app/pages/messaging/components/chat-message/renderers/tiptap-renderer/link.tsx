              ...
              <Flex gap="4">
                <Box className="relative min-w-[18rem] min-h-[9rem] w-72 h-36">
                  ...
                  <Box className="absolute top-0 z-0 left-0 w-72 h-36">
                    <Box className="animate-pulse bg-gray-3 z-0 w-72 h-36 dark:bg-gray-5 rounded-md"></Box>
                  </Box>
                ...
                <Flex direction="column" gap="1" py="1" className="w-84">
                  <Flex gap="1" direction="column">
                    <Text as="span" weight="bold" size="5" className="cal-sans">
                      {linkPreview.title}
                    </Text>
                    <Text as="span" color="gray" size="2" weight="medium">
                      {linkPreview.site_name}
                    </Text>
                  </Flex>
                  <Text as="p" size="2" className="whitespace-break-spaces">
            ...
            <Flex gap="4">
              ...
              <Flex direction="column" gap="1" py="1" className="w-84">
                ...
                <Text
                  as="p"
                  size="2"
                  className="whitespace-break-spaces line-clamp-2"
                >
                  {isScrolling ? (
