      ...
      {({ isActive }) => {
        return (
          <Flex
            ...
            px="3"
            className={clsx(
              "cursor-pointer text-black dark:text-gray-100 user-select-none rounded-md no-underline transition-all duration-200 hover:bg-gray-3 dark:hover:bg-gray-5",
...
export const SidebarButtonItem = ({
  children,
  subtle,
  onClick,
  isLoading,
  ...
  return (
    <Flex
      ...
      px="3"
      className={
        "user-select-none rounded-md py-1.5 transition-all duration-200 hover:bg-slate-3 hover:text-slate-11 " +
        cursor
      }
      onClick={onClick}
      {...props}
...
export const SidebarViewMoreButton = ({
  onClick,
  ...props
}: SidebarViewMoreButtonProps) => {
